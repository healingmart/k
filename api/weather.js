...
function getLocationCoordinates() {
    return {
        ...
        // 강원도 (전체)
        '춘천': { lat: 37.8813, lon: 127.7298, name: '강원 춘천시' },
        '원주': { lat: 37.3422, lon: 127.9202, name: '강원 원주시' },
        '강릉': { lat: 37.7519, lon: 128.8761, name: '강원 강릉시' },
        '동해': { lat: 37.5244, lon: 129.1144, name: '강원 동해시' },
        '태백': { lat: 37.1640, lon: 128.9856, name: '강원 태백시' },
        '속초': { lat: 38.2070, lon: 128.5918, name: '강원 속초시' },
        '삼척': { lat: 37.4497, lon: 129.1658, name: '강원 삼척시' },
        '홍천': { lat: 37.6971, lon: 127.8897, name: '강원 홍천군' },
        '횡성': { lat: 37.4914, lon: 127.9858, name: '강원 횡성군' },
        '영월': { lat: 37.1836, lon: 128.4617, name: '강원 영월군' },
        '평창': { lat: 37.3708, lon: 128.3901, name: '강원 평창군' },
...
function findLocationCoordinates(query) {
    ...
    // 기본값: 서울
    console.log(`매칭 실패, 기본값 사용: ${query} -> 서울`);
    return locations['서울'];
}
...
module.exports = async function handler(req, res) {
    ...
    try {
        const { region = '서울', lat, lon, detailed = 'true' } = req.query;
        ...
        return res.status(200).json({
            ...
            data: generateCompleteSampleData(req.query.region || '서울', error.message),
            locationInfo: {
                requested: req.query.region || '서울',
                matched: '오류로 인한 기본값',
                fullName: '서울특별시',
                source: '오류 처리'
            },
